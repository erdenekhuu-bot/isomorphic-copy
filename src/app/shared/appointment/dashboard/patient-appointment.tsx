          ...
          >
            ...
            >
              ...
              <Area
                dataKey="newPatients"
                {...(theme && {
                  stroke: COLORS[0][theme.palette.mode],
                })}
                strokeWidth={3}
                fillOpacity={1}
                ...
                dot={
                  <CustomizedDot
                    color={theme && COLORS[0][theme.palette.mode]}
                  />
                }
                activeDot={
                  <CustomizedDot
              ...
              <Area
                ...
                {...(theme && {
                  stroke: COLORS[1][theme.palette.mode],
                })}
                strokeWidth={3}
                fillOpacity={1}
                fill="url(#amountCustomer)"
                dot={
                  <CustomizedDot
                    color={theme && COLORS[1][theme.palette.mode]}
                  />
                }
                activeDot={
                  <CustomizedDot
      ...
      {patientLegend.map((item, index) => (
        ...
        >
          <span
            ...
            {...(theme && {
              style: {
                backgroundColor: COLORS[index][theme.palette.mode],
              },
            })}
          />
          <span>{item.name}</span>

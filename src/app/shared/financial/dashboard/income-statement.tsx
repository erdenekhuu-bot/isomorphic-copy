      ...
      {ticketStatus.map((item, index) => (
        <div key={item.name} className="flex items-center gap-1.5">
          <span
            ...
            {...(theme && {
              style: {
                backgroundColor: COLORS[index][theme.palette.primary.light],
              },
            })}
          />
          ...
          <ResponsiveContainer width="100%" height="100%" minWidth="1610px">
            ...
            >
              ...
              <Bar
                dataKey="revenue"
                {...(theme && {
                  fill: COLORS[0][theme.palette.primary.contrastText],
                })}
                barSize={28}
                radius={[4, 4, 0, 0]}
              />
              <Bar
                ...
                dataKey="expense"
                {...(theme && {
                  fill: COLORS[1][theme.palette.primary.dark],
                })}
                barSize={28}
                radius={[4, 4, 0, 0]}
              />
              <Bar
                ...
                dataKey="grossMargin"
                {...(theme && {
                  fill: COLORS[2][theme.palette.primary.main],
                })}
                barSize={28}
                radius={[4, 4, 0, 0]}
              />

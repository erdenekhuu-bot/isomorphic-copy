...
import RepeatCustomerRate from "./repeat-customer-rate";
import UserLocation from "./user-location";
import PromotionalSales from "./promotional-sales";
  ...
  return (
    <div className="@container">
      <div className="grid grid-cols-1 gap-6 @4xl:grid-cols-2 @7xl:grid-cols-12 3xl:gap-8">
        ...
        >
          <a href={routes.eCommerce.createProduct} className="inline-flex">
